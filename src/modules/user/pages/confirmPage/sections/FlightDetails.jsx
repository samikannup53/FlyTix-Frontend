export const FlightDetails = ({ booking }) => {
    ...
    return (
      <div className={!isFirst ? "pt-4 mt-4 border-t border-gray-200" : ""}>
        {booking.tripType === "Roundtrip" && (
          <div className="flex gap-4 items-center mb-2">
            <p className="text-base font-semibold text-gray-800">
              {info.departureCity} <i className="fa fa-arrow-right mx-2" /> {info.arrivalCity}
            </p>
        ...
        <p className="text-sm text-gray-500 mt-2">
          ...
          {journey.travelClass?.[0].toUpperCase() + journey.travelClass?.slice(1).toLowerCase()} Class
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between mt-2">
          ...
          <div className="flex items-center gap-3 sm:w-1/3">
            ...
            />
            <div>
              <p className="text-lg font-bold text-gray-800">{info.departureTime}</p>
          ...
          <div className="text-right sm:w-1/3">
            <p className="text-lg font-bold text-gray-800">{info.arrivalTime}</p>
            <p className="text-sm font-medium text-gray-700">
