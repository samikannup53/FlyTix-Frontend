  ...
  return (
    <div className="flex justify-center mt-8">
      <div className="flex items-center gap-4">
        {/* Icon Box */}
        <div className="flex items-center justify-center w-12 h-12 rounded-full border-2 border-pink-600 text-pink-700 text-xl">
        ...
        <div className="text-gray-700 text-sm md:text-base leading-snug">
          <p className="font-semibold text-base text-gray-800 text-center md:text-left">
            ...
            <span className="text-pink-700">FlyNow !</span>
          </p>
