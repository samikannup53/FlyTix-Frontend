  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-yellow-100/50 to-yellow-200/50">
      ...
      <main className="flex-grow flex items-center justify-center px-4">
        <div className="w-full max-w-7xl h-[70vh] bg-white/30 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
          {/* Left Panel */}
          <div className="hidden md:flex w-1/2 relative items-center justify-center p-6 bg-gradient-to-br from-orange-800 to-pink-900 rounded-l-3xl">
            ...
            <img src="https://randomuser.me/api/portraits/men/12.jpg" className="absolute top-45 right-4 w-12 h-12 rounded-full border-2 border-orange-200 z-20 shadow-md" />
            ...
            <img src="https://randomuser.me/api/portraits/women/22.jpg" className="absolute bottom-[150px] left-50 w-11 h-11 rounded-full border-2 border-pink-200 z-20 shadow" />
            ...
            <div className="relative z-30 px-6 text-center max-w-md space-y-5">
              ...
              <p className="text-yellow-300 text-sm md:text-lg font-extralight italic drop-shadow-sm">
                <i className="fas fa-quote-left text-yellow-300 text-2xl"></i> "Every journey begins with a single click"
              </p>
            </div>
          </div>

          {/* Right Side - Login Form */}
          <div className="w-full md:w-1/2 p-6 flex items-center justify-center bg-white/70 backdrop-blur-lg rounded-r-3xl shadow-lg relative">
            {/* Back */}
            <span className="absolute top-5 left-5 sm:top-7 sm:left-7 text-pink-700 flex items-center gap-2 hover:text-pink-800 transition-all">
            ...
            <div className="w-full max-w-md space-y-6">
              <h2 className="text-center text-4xl font-extrabold text-pink-700 drop-shadow-sm">
                Welcome Back
              </h2>
