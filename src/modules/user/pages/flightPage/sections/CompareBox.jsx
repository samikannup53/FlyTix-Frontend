        ...
        <>
          ...
          {minimized ? (
            <div
              ...
              className="fixed bottom-4 right-4 w-14 h-14 bg-gradient-to-br from-pink-700 to-pink-800 text-white rounded-full shadow-lg flex flex-col items-center justify-center z-50 cursor-pointer"
            ...
            <div className="fixed bottom-4 right-4 w-80 rounded-xl shadow-2xl border border-gray-200 z-40 overflow-hidden bg-white">
              {/* Header */}
